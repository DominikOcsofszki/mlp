...
with mlflow.start_run(run_name=RUN_SAVE_NAME):
    ...
    if use_2_classifier:
        ###ADDING 2. Classifier
        pick_2_classifier = model.MyModel5_retry_2classes_faster_4().to(DEVICE)
    ...
    if TRAIN_VAE:
        for epoch in range(EPOCHS):
            ...
            for i, (x, y) in loop:
                ...
                nr_of_classifier = 1
                LABEL_FACTOR = 1
                REC_LOSS_FACTOR = 1/nr_of_classifier * 1
                KL_DIV_FACTOR = 1
